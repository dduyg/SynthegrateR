...
integrate_data <- function(csv_files, excel_files, db_path, sql_query, merge_strategy = "inner", key_columns = NULL) {
  ...
  integrated_data <- list(csv_data, excel_data, sql_data, json_data, xml_data) %>% 
...
generate_documentation <- function() {
  ...
  cat("Usage: integrate_data(csv_files, excel_files, db_path, sql_query, merge_strategy = 'inner', key_columns = NULL)\n")
  cat("\n")
  cat("Parameters:\n")
  ...
  cat("\n")
  cat("Examples:\n")
  cat("integrated_data <- integrate_data(csv_files, excel_files, db_path, sql_query)\n")
}
...
# Integrate data
integrated_data <- integrate_data(csv_files, excel_files, db_path, sql_query)
